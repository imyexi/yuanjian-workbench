...
4. **先看结论，再看图表与画像。**在「历史报告与导出」阅读核心发现、关键词分布和优先人群；在人群相关页面查看八层属性、三层需求、具体场景、购买考虑和验证问题。逐词分类和逐词内容建议只用于后台汇总，原始词与证据仍保留。
...
6. **在报告内验证并交付。**在「历史报告与导出」原地阅读完整报告、查看推荐依据、比较商品并打开历史趋势；历史数据仍由用户主动读取。在这里导出 HTML、Markdown 报告或完整项目包；「竞品参考」保留批量关注和比较入口。
